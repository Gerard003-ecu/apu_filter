...
class TestDataProcessor(unittest.TestCase):
    ...
    def setUp(self):
        ...
        df_presupuesto.to_excel(writer_presupuesto, index=False, startrow=9, sheet_name='Sheet1')
        ...
        df_insumos.to_excel(writer_insumos, index=False, startrow=8, sheet_name='Sheet1')
    ...
    def test_process_files_integration(self):
        ...
        valor_total_apu01 = df_resultado[df_resultado['Código APU'] == 'APU-01']['Valor Total'].iloc[0]
        valor_total_apu02 = df_resultado[df_resultado['Código APU'] == 'APU-02']['Valor Total'].iloc[0]
