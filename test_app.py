...
class TestCSVProcessor(unittest.TestCase):
    ...
    def setUpClass(cls):
        cls.presupuesto_data = (
            ...
            # APU de mano de obra para el estimador
        ...
        # ### CAMBIO CLAVE 1: Corregir el mapeo en la configuración de prueba ###
        cls.test_config = {
            ...
            "param_map": {
                ...
                },  # Corregido: 'INSTALACION' en lugar de 'IZAJE MANUAL'
            },
        }
    ...
    def test_process_all_files_structure_and_calculations(self, mock_config):
        ...
        # Ahora hay 3 items porque añadimos el de mano de obra
...
class TestAppEndpoints(unittest.TestCase):
    ...
    # ### CAMBIO CLAVE 2: Corregir la prueba del endpoint de estimación ###
    @patch("procesador_csv.config", new_callable=lambda: TestCSVProcessor.test_config)
    def test_07_get_estimate_with_session(self, mock_config):
        with self.client as c:
            # Subir archivos para que el data_store de la sesión se popule correctamente
            data = {
                "presupuesto": self._get_test_file(
                    "presupuesto.csv", TestCSVProcessor.presupuesto_data
                ),
            ...
            # La lógica ahora busca en los datos que ya están en la sesión.
