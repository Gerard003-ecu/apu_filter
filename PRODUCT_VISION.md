...
| **$\delta_{\mathrm{Hurwitz}} > \varepsilon_{\mathrm{Wilk}}$** | `quaternionic_state_shifter.py` | **Deriva de Wilkinson:** Mermas de representabilidad por redondeo en FPU de 64 bits ($\|p \cdot q\|_{\mathbb{H}} \neq \|p\| \|q\|$). | **Inestabilidad de-normalizada:** Alerta previa a la inyección de entropía en la caja de la constructora. |
| **$\det(\sigma') \le 0$** | `hydrological_agent.py` | **Plastificación por Licuación (Fango):** Pérdida total de soporte por presiones de poros intersticiales extremas ($P_f = -\gamma_w \psi_w \mathrm{sat}$). | **Peligro inminente de colapso de cimientos:** Disparo del Crowbar en silicio (<400 ns) para detener bombas y mezcladoras. |
| **$i_{\mathrm{grad}} > i_{\mathrm{crit}}$** | `hydrological_agent.py` | **Erosión Interna por Sifonamiento:** Arrastre destructivo de finos en foso por gradientes hidráulicos acelerados ($i_{\mathrm{crit}} = \frac{\rho_{\mathrm{sat}} - \rho_w}{\rho_w}$). | **Deformación geomecánica e inestabilidad:** Daño estructural a cimentaciones de obra civil. |
| **$s_{\mathrm{sc}} > 25\text{ mm}$** | `lithological_agent.py` | **Exceso de Asentamiento (NSR-10):** Deformación vertical por consolidación unidimensional Terzaghi en arcillas compresibles. | **Daños estructurales e agrietamiento de vigas:** Sanciones por incumplimiento de la norma de sismorresistencia NSR-10. |
