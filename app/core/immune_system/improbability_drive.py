...
Módulo: app/core/inmune_system/improbability_drive.py
...
class TensorAlgebra:
    ...
    def compose(
        ...
        if operation == "product":
            ...
            weights = tuple(1.0 / len(tensors) for _ in tensors)
            return TensorAlgebra.weighted_average(tensors, weights)
...
class ImprobabilityDriveService:
    ...
    def register_in_mic(self) -> None:
        ...
        self.mic.register_vector(
            name="compute_improbability_penalty",
