...
| **$\delta_{\mathrm{Hurwitz}} > \varepsilon_{\mathrm{Wilk}}$** | `quaternionic_state_shifter.py` | **Deriva de Wilkinson:** Mermas de representabilidad por redondeo en la FPU de 64 bits en H. | **Inestabilidad de-normalizada:** Alerta previa a la inyección de entropía en la caja de la constructora. |
