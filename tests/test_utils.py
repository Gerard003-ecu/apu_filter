...
class TestValidateNumericValue:
    ...
    def test_validate_field_name_in_message(self):
        ...
        is_valid, msg = utils.validate_numeric_value(-100, field_name="precio", allow_negative=False)
...
class TestValidateSeries:
    ...
    def test_validate_series_mask_mode(self):
        ...
        mask = utils.validate_series(series, return_mask=True, allow_negative=False, allow_zero=False)
