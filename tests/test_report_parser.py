...
class TestReportParser(unittest.TestCase):
    ...
    def test_parses_special_case_herramienta_menor(self):
        ...
        self.assertEqual(len(herramienta), 1, "Debería encontrarse un solo insumo de 'Herramienta Menor'.")
    ...
    def test_assigns_insumos_to_correct_apu_and_category(self):
        ...
        self.assertEqual(insumo_data['apu_code'], '1.2', "El insumo debería pertenecer al APU '1.2'.")
