...
class TestSpectralAnalysisEdgeCases(TestSpectralAnalysisBase):
    ...
    def test_very_sparse_graph(self):
        ...
        # Usar balanced_tree para evitar problemas de compatibilidad con versiones de NetworkX
        # random_tree fue movido/eliminado en algunas versiones
        G = nx.balanced_tree(r=2, h=4)  # Árbol binario de altura 4 (~31 nodos)
        G = G.to_directed()
