...
def mock_path_resolve():
    ...
    with patch("pathlib.Path.resolve") as mock_resolve:
        ...
        def side_effect():
            return MagicMock(spec=Path, exists=lambda: True, is_file=lambda: True, stat=lambda: MagicMock(st_size=1024, st_mode=0o100444), suffix=".csv")
...
def test_load_from_csv_success(mock_read_csv, mock_path_exists, mock_path_is_file, mock_path_stat):
...
def test_load_from_csv_empty_error(mock_read_csv, mock_path_exists, mock_path_is_file, mock_path_stat):
...
def test_load_from_csv_encoding_error(mock_read_csv, mock_path_exists, mock_path_is_file, mock_path_stat):
...
def test_load_from_xlsx_single_sheet_success(mock_read_excel, mock_path_exists, mock_path_is_file, mock_path_stat):
...
@patch("pandas.read_excel")
def test_load_from_xlsx_all_sheets_success(mock_read_excel, mock_path_exists, mock_path_is_file, mock_path_stat):
...
def test_load_from_xlsx_sheet_not_found(mock_read_excel, mock_path_exists, mock_path_is_file, mock_path_stat):
...
def test_load_from_pdf_no_tables(mock_pdf_open, mock_path_exists, mock_path_is_file, mock_path_stat, caplog):
...
@patch("pdfplumber.open")
def test_load_from_pdf_with_dirty_tables(mock_pdf_open, mock_path_exists, mock_path_is_file, mock_path_stat):
...
@patch("pdfplumber.open")
def test_load_from_pdf_with_table_settings(mock_pdf_open, mock_path_exists, mock_path_is_file, mock_path_stat):
...
def test_load_data_routes_to_csv(mock_loader, mock_path_exists, mock_path_is_file, mock_path_stat):
...
def test_load_data_routes_to_xlsx(mock_loader, mock_path_exists, mock_path_is_file, mock_path_stat):
...
def test_load_data_routes_to_pdf(mock_loader, mock_path_exists, mock_path_is_file, mock_path_stat):
